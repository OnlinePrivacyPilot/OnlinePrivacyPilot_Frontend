...
export const DisplayResults = (props) => {
    ...
    return (
        <div id="results" className={`${fingerprints.length === 0 ? "invisible" : "visible"} flex flex-wrap items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6`}>
