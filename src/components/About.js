...
function About() {
    const ABOUT_SRC = 'https://raw.githubusercontent.com/OnlinePrivacyPilot/OnlinePrivacyPilot_UserDoc/master/ABOUT.md';
    ...
    return (
        <div className='min-h-[90vh] py-16 px-4'>
            <div className='rounded-lg border-2 border-solid border-zinc-300 p-12'>
                {error ? (
                    <p>Unable to load "about" section from the <a href={ABOUT_SRC}>Git repository</a>.</p>
                ) : (
                    responseStatus === 200 ? (
